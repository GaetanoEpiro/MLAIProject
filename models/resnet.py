...
class ResNet(nn.Module):
    def __init__(self, block, layers, classes=100, jigsaw_classes=31, rotation_classes=4, odd_classes=9):
        self.inplanes = 64
...
def resnet18(classes, jigsaw_classes, rotation_classes, odd_classes, pretrained=True, **kwargs):
    """Constructs a ResNet-18 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(BasicBlock, [2, 2, 2, 2], classes, jigsaw_classes, rotation_classes, odd_classes, **kwargs)
    if pretrained:
