...
def get_train_dataloader(args):
    ...
    for dname in dataset_list:
        ...
        train_dataset = Dataset(name_train, labels_train, args.path_dataset, img_transformer=img_transformer, beta_scrambled=args.beta_scrambled, beta_rotated=args.beta_rotated, beta_odd=args.beta_odd)
        datasets.append(train_dataset)

        val_dataset = TestDataset(name_val, labels_val, args.path_dataset, img_transformer=val_trasformer, beta_scrambled=args.beta_scrambled, beta_rotated=args.beta_rotated, beta_odd=args.beta_odd)
...
def get_jigsaw_dataloader(args):
    ...
    train_dataset = Dataset(names, labels, args.path_dataset, img_transformer=img_tr, beta_scrambled=args.beta_scrambled, beta_rotated=args.beta_rotated, beta_odd=args.beta_odd)
...
def get_val_dataloader(args):
    ...
    val_dataset = TestDataset(names, labels, args.path_dataset, img_transformer=img_tr, beta_scrambled=args.beta_scrambled, beta_rotated=args.beta_rotated, beta_odd=args.beta_odd)
